...
const s = StyleSheet.create({
  ...
  bankBox: { border: '1pt solid #ccc', padding: '10pt 12pt', fontSize: 8.5, lineHeight: 1.8 },
  bankTitle: { fontFamily: 'NotoSansJP', fontWeight: 700, marginBottom: 4, fontSize: 8.5 },
...
export function ClassicTemplate({ data, stampDataUrl, stampSize = 64 }: Props) {
