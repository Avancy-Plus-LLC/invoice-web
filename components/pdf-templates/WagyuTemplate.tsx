...
function HDivider({ color = RED, thick = false }: { color?: string; thick?: boolean }) {
  return (
...
const s = StyleSheet.create({
  ...
  titleSub: { fontSize: 8, color: RED_MID, letterSpacing: 3 },
  metaRow: { flexDirection: 'row', justifyContent: 'flex-end', marginBottom: 10 },
  metaText: { fontSize: 8, color: MUTED },
  metaAccent: { color: RED_MID, fontFamily: 'NotoSansJP', fontWeight: 700 },
  ...
  summaryBox: { backgroundColor: RED_LIGHT, borderLeft: `3pt solid ${RED}`, padding: '10pt 16pt', marginBottom: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  summaryLabel: { fontSize: 8, color: RED_MID, marginBottom: 3, letterSpacing: 0.5 },
  summaryAmount: { fontSize: 20, fontFamily: 'NotoSansJP', fontWeight: 700, color: RED },
  ...
  tableHeaderRow: { flexDirection: 'row', backgroundColor: RED, borderRadius: 2, marginBottom: 2 },
  ...
  grandRow: { flexDirection: 'row', width: 210, backgroundColor: RED, borderRadius: 2 },
  ...
  bankBox: { border: `1pt solid #e7e5e4`, padding: '8pt 12pt', fontSize: 8.5, lineHeight: 1.8 },
  bankTitle: { fontFamily: 'NotoSansJP', fontWeight: 700, color: RED_MID, marginBottom: 4, fontSize: 8.5 },
  notesBox: { border: `1pt solid #e7e5e4`, padding: '8pt 12pt', fontSize: 8.5, minHeight: 44 },
  notesTitle: { fontFamily: 'NotoSansJP', fontWeight: 700, color: RED_MID, marginBottom: 4, fontSize: 8.5 },
});

type Props = { data: InvoiceData; stampDataUrl?: string | null; stampSize?: number };

export function WagyuTemplate({ data, stampDataUrl, stampSize = 64 }: Props) {
