...
const s = StyleSheet.create({
  ...
  sidebar: { position: 'absolute', top: 0, left: 0, width: '32%', height: '100%', backgroundColor: NAVY },
  mainArea: { marginLeft: '32%', padding: '18pt 20pt 18pt 22pt' },

  sideContent: { padding: '24pt 16pt' },
  sideTitle: { fontSize: 22, fontFamily: 'NotoSansJP', fontWeight: 700, color: GOLD, letterSpacing: 3, marginBottom: 4 },
  sideTitleJa: { fontSize: 9, color: 'rgba(255,255,255,0.5)', letterSpacing: 2, marginBottom: 28 },
  sideLabel: { fontSize: 7, color: 'rgba(255,255,255,0.5)', letterSpacing: 1, marginBottom: 3, marginTop: 12 },
  sideValue: { fontSize: 9, color: '#fff', fontFamily: 'NotoSansJP', fontWeight: 700 },
  sideDivider: { borderBottom: `0.5pt solid ${GOLD}`, marginTop: 20, marginBottom: 16 },
  sideIssuerLabel: { fontSize: 7, color: 'rgba(255,255,255,0.5)', letterSpacing: 1, marginBottom: 6 },
  sideIssuerName: { fontSize: 10, fontFamily: 'NotoSansJP', fontWeight: 700, color: '#fff', marginBottom: 4 },
  sideIssuerText: { fontSize: 7.5, color: 'rgba(255,255,255,0.7)', lineHeight: 1.8 },
  ...
  clientName: { fontSize: 16, fontFamily: 'NotoSansJP', fontWeight: 700, borderBottom: `1.5pt solid ${GOLD}`, paddingBottom: 4, marginBottom: 3 },
  honorific: { fontSize: 8.5, color: MUTED },

  amountBox: { backgroundColor: GOLD_LIGHT, borderLeft: `4pt solid ${GOLD}`, padding: '10pt 14pt', marginBottom: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  amountLabel: { fontSize: 8, color: '#92400e', marginBottom: 3, letterSpacing: 0.5 },
  amountValue: { fontSize: 20, fontFamily: 'NotoSansJP', fontWeight: 700, color: NAVY },
  ...
  tableHeader: { flexDirection: 'row', backgroundColor: NAVY, borderRadius: 2, marginBottom: 2 },
  ...
  thNo: { width: '5%', padding: '5pt 4pt', color: GOLD, fontSize: 7.5, textAlign: 'center', fontFamily: 'NotoSansJP', fontWeight: 700 },
  ...
  grandRow: { flexDirection: 'row', width: 210, backgroundColor: NAVY, borderRadius: 2 },
  grandLabel: { width: 110, textAlign: 'right', padding: '5pt 8pt', color: GOLD, fontSize: 10, fontFamily: 'NotoSansJP', fontWeight: 700 },
  ...
  bankTitle: { fontFamily: 'NotoSansJP', fontWeight: 700, color: GOLD, marginBottom: 4, fontSize: 8.5 },
  notesBox: { border: `1pt solid #e7e5e4`, padding: '8pt 10pt', borderRadius: 2, fontSize: 8.5, minHeight: 44 },
  notesTitle: { fontFamily: 'NotoSansJP', fontWeight: 700, color: GOLD, marginBottom: 4, fontSize: 8.5 },
});

type Props = { data: InvoiceData; stampDataUrl?: string | null; stampSize?: number };

export function NightTemplate({ data, stampDataUrl, stampSize = 45 }: Props) {
