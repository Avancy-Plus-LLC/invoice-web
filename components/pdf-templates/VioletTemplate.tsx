...
const s = StyleSheet.create({
  ...
  topBar: { backgroundColor: VIOLET, padding: '18pt 20pt 14pt 20pt', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' },
  ...
  clientBlock: { flex: 1 },
  clientNameWrap: { borderLeft: `3pt solid ${VIOLET}`, paddingLeft: 8, marginBottom: 4 },
  ...
  amountCard: { backgroundColor: VIOLET_LIGHT, borderLeft: `4pt solid ${VIOLET}`, padding: '10pt 16pt', marginBottom: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderRadius: 4 },
  amountLabel: { fontSize: 8.5, color: '#8b5cf6', marginBottom: 3 },
  amountValue: { fontSize: 20, fontFamily: 'NotoSansJP', fontWeight: 700, color: VIOLET },
  amountDue: { alignItems: 'flex-end' },
  amountDueLabel: { fontSize: 8, color: MUTED, marginBottom: 2 },
  amountDueValue: { fontSize: 9.5, fontFamily: 'NotoSansJP', fontWeight: 700 },
  tableHeader: { flexDirection: 'row', backgroundColor: VIOLET, borderRadius: 3, marginBottom: 2 },
  tableRow: { flexDirection: 'row', borderBottom: `0.5pt solid #e2e8f0` },
  tableRowEven: { flexDirection: 'row', borderBottom: `0.5pt solid #e2e8f0`, backgroundColor: '#faf5ff' },
  ...
  totalDivider: { width: 220, borderBottom: `1pt solid ${VIOLET}`, marginBottom: 2 },
  grandRow: { flexDirection: 'row', width: 220, backgroundColor: VIOLET, borderRadius: 3 },
  ...
  bankBox: { flex: 1, backgroundColor: VIOLET_LIGHT, border: `1pt solid #ddd6fe`, padding: '8pt 10pt', borderRadius: 3, fontSize: 8.5, lineHeight: 1.7 },
  bankTitle: { fontFamily: 'NotoSansJP', fontWeight: 700, color: VIOLET, marginBottom: 4 },
  notesBox: { flex: 1, border: `1pt solid #ddd6fe`, padding: '8pt 10pt', borderRadius: 3, fontSize: 8.5, minHeight: 50 },
  notesTitle: { fontFamily: 'NotoSansJP', fontWeight: 700, color: VIOLET, marginBottom: 4 },
});

type Props = { data: InvoiceData; stampDataUrl?: string | null; stampSize?: number };

export function VioletTemplate({ data, stampDataUrl, stampSize = 45 }: Props) {
        ...
        <View style={s.body}>
          ...
          <View style={s.bottomRow}>
            ...
            <View style={s.notesBox}>
              ...
              <Text style={{ fontSize: 8.5, color: MUTED }}>{data.notes || ' '}</Text>
            </View>
          </View>
        </View>
      </Page>
