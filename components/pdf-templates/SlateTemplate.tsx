...
const s = StyleSheet.create({
  ...
  topBar: { backgroundColor: SLATE, padding: '18pt 20pt 14pt 20pt', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' },
  titleText: { fontSize: 26, fontFamily: 'NotoSansJP', fontWeight: 700, color: '#fff', letterSpacing: 3 },
  topMeta: { alignItems: 'flex-end' },
  topMetaLabel: { fontSize: 7.5, color: 'rgba(255,255,255,0.65)', marginBottom: 2 },
  ...
  clientBlock: { flex: 1 },
  clientNameWrap: { borderLeft: `3pt solid ${INDIGO}`, paddingLeft: 8, marginBottom: 4 },
  ...
  amountCard: { backgroundColor: INDIGO_LIGHT, borderLeft: `4pt solid ${INDIGO}`, padding: '10pt 16pt', marginBottom: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderRadius: 4 },
  amountLabel: { fontSize: 8.5, color: INDIGO, marginBottom: 3 },
  amountValue: { fontSize: 20, fontFamily: 'NotoSansJP', fontWeight: 700, color: INDIGO },
  ...
  tableHeader: { flexDirection: 'row', backgroundColor: SLATE, borderRadius: 3, marginBottom: 2 },
  ...
  totalDivider: { width: 220, borderBottom: `1pt solid ${INDIGO}`, marginBottom: 2 },
  grandRow: { flexDirection: 'row', width: 220, backgroundColor: INDIGO, borderRadius: 3 },
  ...
  bankBox: { flex: 1, backgroundColor: INDIGO_LIGHT, border: `1pt solid #c7d2fe`, padding: '8pt 10pt', borderRadius: 3, fontSize: 8.5, lineHeight: 1.7 },
  bankTitle: { fontFamily: 'NotoSansJP', fontWeight: 700, color: INDIGO, marginBottom: 4 },
  notesBox: { flex: 1, border: `1pt solid #c7d2fe`, padding: '8pt 10pt', borderRadius: 3, fontSize: 8.5, minHeight: 50 },
  notesTitle: { fontFamily: 'NotoSansJP', fontWeight: 700, color: SLATE, marginBottom: 4 },
});

type Props = { data: InvoiceData; stampDataUrl?: string | null; stampSize?: number };

export function SlateTemplate({ data, stampDataUrl, stampSize = 45 }: Props) {
