...
const s = StyleSheet.create({
  ...
  topBar: { backgroundColor: TEAL, padding: '18pt 20pt 14pt 20pt', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' },
  ...
  clientBlock: { flex: 1 },
  clientNameWrap: { borderLeft: `3pt solid ${TEAL}`, paddingLeft: 8, marginBottom: 4 },
  ...
  amountCard: { backgroundColor: TEAL_LIGHT, borderLeft: `4pt solid ${TEAL}`, padding: '10pt 16pt', marginBottom: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderRadius: 4 },
  amountLabel: { fontSize: 8.5, color: '#0891b2', marginBottom: 3 },
  amountValue: { fontSize: 20, fontFamily: 'NotoSansJP', fontWeight: 700, color: TEAL },
  ...
  tableHeader: { flexDirection: 'row', backgroundColor: TEAL, borderRadius: 3, marginBottom: 2 },
  tableRow: { flexDirection: 'row', borderBottom: `0.5pt solid #e2e8f0` },
  tableRowEven: { flexDirection: 'row', borderBottom: `0.5pt solid #e2e8f0`, backgroundColor: '#f0fdff' },
  ...
  totalDivider: { width: 220, borderBottom: `1pt solid ${TEAL}`, marginBottom: 2 },
  grandRow: { flexDirection: 'row', width: 220, backgroundColor: TEAL, borderRadius: 3 },
  ...
  bankBox: { flex: 1, backgroundColor: '#f0fdff', border: `1pt solid #a5f3fc`, padding: '8pt 10pt', borderRadius: 3, fontSize: 8.5, lineHeight: 1.7 },
  bankTitle: { fontFamily: 'NotoSansJP', fontWeight: 700, color: TEAL, marginBottom: 4 },
  notesBox: { flex: 1, border: `1pt solid #a5f3fc`, padding: '8pt 10pt', borderRadius: 3, fontSize: 8.5, minHeight: 50 },
  notesTitle: { fontFamily: 'NotoSansJP', fontWeight: 700, color: TEAL, marginBottom: 4 },
});

type Props = { data: InvoiceData; stampDataUrl?: string | null; stampSize?: number };

export function OceanTemplate({ data, stampDataUrl, stampSize = 45 }: Props) {
